...
export const EcommercePage = () => {
  ...
  const testimonialsData = {
    ...
    testimonials: [
      {
        quote:
          "Increased our sales by 300% in the first quarter. The platform is incredibly easy to use.",
        author: {
          name: "Sarah Johnson",
          position: "Founder",
          company: "Style Co.",
      ...
      {
        quote:
          "Best decision we made for our business. Customer support is outstanding.",
        author: {
          name: "Mike Chen",
          position: "CEO",
      ...
      {
        quote:
          "The analytics and insights help us make better business decisions every day.",
        author: {
...
export const TestimonialsPage = () => {
  const allTestimonialsData = {
    ...
    description:
      "Real stories from real customers who've transformed their businesses",
    testimonials: [
      {
        quote:
          "This platform revolutionized how we handle customer data. The insights we get are incredible.",
        author: {
          name: "Alex Thompson",
      ...
      {
        quote:
          "Implementation was seamless. Our team was up and running in less than a week.",
        author: {
          name: "Maria Garcia",
      ...
      {
        quote:
          "The customer support is exceptional. They truly care about our success.",
        author: {
          name: "James Wilson",
          position: "Founder",
          company: "StartupXYZ",
      ...
      {
        quote:
          "ROI was positive within the first month. Couldn't be happier with our choice.",
        author: {
          name: "Lisa Chen",
          position: "CFO",
      ...
      {
        quote:
          "Security and compliance features are top-notch. Perfect for our industry.",
        author: {
          name: "Rachel Kim",
