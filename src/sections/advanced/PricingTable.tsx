...
const PricingTable = ({ title, description, plans, showYearlyDiscount = true }: PricingTableProps) => {
      ...
      <div className="container">
        <div className="row justify-center">
          <div className="lg:col-8 text-center">
            ...
            <p className="mb-8 text-light" dangerouslySetInnerHTML={markdownify(description)} />
            ...
            <div key={index} className="lg:col-4 md:col-6">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <AnimatedAnchor
                    className={plan.highlighted ? "btn-primary w-full mb-6" : "btn-outline-primary w-full mb-6"}
