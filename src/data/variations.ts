...
export const saasBannerContent: HomeBannerData = {
  ...
  description:
    "Complete platform management, automated billing, and powerful analytics to grow your software business.",
  image: {
...
export const ecommerceBannerContent: HomeBannerData = {
  ...
  description:
    "Everything you need to create, customize, and scale your e-commerce business.",
  image: {
...
export const agencyBannerContent: HomeBannerData = {
  ...
  description:
    "White-label platform with client management, project tracking, and reporting tools.",
  image: {
...
export const securityFeaturesContent: FeatureItem[] = [
  {
    ...
    description:
      "Advanced encryption, compliance, and security monitoring to protect your business data.",
    list: [
  ...
  },
  {
    ...
    description:
      "Built-in compliance tools and audit trails for regulated industries.",
    list: [
  ...
  },
  {
    ...
    description:
      "Advanced data protection with backup, recovery, and disaster planning.",
    list: [
...
export const performanceFeaturesContent: FeatureCardData = {
  ...
  description:
    "Optimized infrastructure and intelligent caching for lightning-fast performance.",
  features: [
    {
      title: "Global CDN",
      description:
        "Content delivered from 200+ edge locations worldwide for optimal speed.",
    ...
    },
    {
      title: "Smart Caching",
      description:
        "Intelligent caching strategies that reduce load times by up to 90%.",
    ...
    },
    {
      ...
      description:
        "Monitor performance metrics and get alerts before issues impact users.",
...
export const developerIntegrationsContent: IntegrationData = {
  ...
  description:
    "Comprehensive APIs, SDKs, and tools for developers to build and extend.",
  integrations: [
    {
      name: "REST API",
      slug: "rest-api",
      icon: "/images/integration/api.svg",
    ...
    },
    {
      name: "GraphQL",
      slug: "graphql",
      icon: "/images/integration/graphql.svg",
    ...
    },
    {
      name: "Webhooks",
      slug: "webhooks",
      icon: "/images/integration/webhooks.svg",
    ...
    },
    {
      name: "CLI Tools",
      slug: "cli-tools",
      icon: "/images/integration/cli.svg",
    ...
    },
    {
      name: "VS Code",
      slug: "vscode",
      icon: "/images/integration/vscode.svg",
    ...
    },
    {
      name: "Postman",
      slug: "postman",
      icon: "/images/integration/postman.svg",
    ...
    },
    {
      name: "GitHub Actions",
      slug: "github-actions",
      icon: "/images/integration/github.svg",
    ...
    },
    {
      name: "GitLab CI",
      slug: "gitlab-ci",
      icon: "/images/integration/gitlab.svg",
...
export const startupTeamContent: TeamData = {
  ...
  description:
    "The passionate entrepreneurs building the future of business technology.",
  members: [
    {
      name: "Alex Chen",
    ...
    },
    {
      ...
      social: [
        {
          platform: "LinkedIn",
          url: "https://linkedin.com/in/sarahkim",
          icon: "/images/icons/svg/linkedin.svg",
        },
        {
          platform: "GitHub",
...
export const innovationValuesContent: ValuesData = {
  ...
  description:
    "The core principles that fuel our innovation and guide our decisions.",
  values: [
    {
      title: "Rapid Innovation",
      description:
        "We ship fast, learn quickly, and iterate based on real user feedback.",
      icon: "/images/icons/svg/rocket.svg",
    },
    {
      title: "User-Centric Design",
      description:
        "Every feature is designed with the end user's experience at the forefront.",
      icon: "/images/icons/svg/customer.svg",
    },
    {
      title: "Open Source",
      description:
        "We believe in contributing back to the community and open source ecosystem.",
      icon: "/images/icons/svg/collaboration.svg",
    },
    {
      title: "Data-Driven",
      description:
        "All our decisions are backed by data, metrics, and measurable outcomes.",
      icon: "/images/icons/svg/chart.svg",
    },
  ],
};
...
export const urgencyCtaContent: CallToActionData = {
  ...
  description:
    "Join thousands of companies already using our platform. Offer expires soon!",
  image: {
...
export const contactSalesCtaContent: CallToActionData = {
  ...
  description:
    "Talk to our sales team about enterprise plans, custom integrations, and volume discounts.",
  image: {
